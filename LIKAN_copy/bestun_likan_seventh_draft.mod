...
/* ------ Markfall & Skorður --------*/
minimize MaxAlag: TheMaxAlag + sum{t in 1..T, d in 1..D} 300*SuperAlag[t,d] + MaxDagsAlag + sum{t in 1..T, d in 1..D}( LB1[t,d]+ LB2[t,d]+ LB3[t,d]+ LB4[t,d]+ LB5[t,d]+ LB6[t,d]+ LB7[t,d]);
